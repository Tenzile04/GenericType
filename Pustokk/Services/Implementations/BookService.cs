...
namespace Pustokk.Services.Implementations
{
    public class BookService : IBookService
    {
        ...
        public async Task CreateAsync(Book entity)
        {
            ...
            {
                throw new InvalidNotFoundExceptionException("GenreId", "Genre not found!");
            }

            if (!_authorRepository.Table.Any(x => x.Id == entity.AuthorId))
            {
                throw new InvalidNotFoundExceptionException("AuthorId", "Author not found!");
            }
            ...
            if (check)
            {
                throw new InvalidNotFoundExceptionException("TagId", "Tag not found!");
            }
            else
            {
                if (entity.TagIds != null)
            ...
            if (entity.BookPosterImageFile != null)
            {
                ...
                {
                    throw new InvalidContentTypeException("BookPosterImageFile", "File must be .png or .jpeg (.jpg)");
                }
